...
We can see from the above a simple summary of the kind of feature that we have data on. If we call the `summary` function we'll get a more detailed understanding of the bef data available.
